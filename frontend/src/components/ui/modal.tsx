...
>(({ className, children, ...props }, ref) => (
  <ModalPortal>
    ...
    <DialogPrimitive.Content
      ...
      {...props}
    >
      <div className="absolute top-0 left-0 right-0 h-[3px] rounded-t-xl gold-gradient" />
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg opacity-70 ring-offset-background transition-all duration-200 hover:opacity-100 hover:bg-accent p-1 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2">
        <X className="h-4 w-4" />
